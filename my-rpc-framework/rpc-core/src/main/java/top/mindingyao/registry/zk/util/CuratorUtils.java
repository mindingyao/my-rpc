package top.mindingyao.registry.zk.util;
...
import top.mindingyao.enumeration.RpcConfigEnum;
import top.mindingyao.util.PropertiesFileUtil;
...
public class CuratorUtils {
    ...
    private static final String SERVER_ADDR = "127.0.0.1:9999";
